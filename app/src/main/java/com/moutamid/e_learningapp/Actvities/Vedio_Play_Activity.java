...
public class Vedio_Play_Activity extends AppCompatActivity implements MediaPlayer.OnCompletionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vw.setOnCompletionListener(Vedio_Play_Activity.this);
